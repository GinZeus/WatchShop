<%-- 
    ...
    Created on : 27-10-2023, 17:18:17
    Author     : DELL
--%>
                        ...
                        <div id="customer-orders" class="col-lg-9"> 
                            <div class="box">
                                ...
                                <div class="nav flex-column flex-md-row nav-pills text-center ">
                                    ...
                                    <a href="CancelledController" class="nav-link flex-sm-fill text-sm-center  font-weight-bold border-bottom border-primary"> <i class="fa fa-ban">                  </i>Cancelled</a>
