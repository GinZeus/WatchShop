                        ...
                        <div id="customer-orders" class="col-lg-9"> 
                            <div class="box">
                                ...
                                <div class="nav flex-column flex-md-row nav-pills text-center ">
                                    ...
                                    <a href="ToReceiveController" class="nav-link flex-sm-fill text-sm-center font-weight-bold border-bottom border-primary  "> <i class="fa fa-opencart"></i>Received</a>
                                        ...
                                        <tbody>
                                            <c:forEach items="${listO}" var="o">
                                                <tr>
                                                    <th># ${o.order_id}</th>
                                                    <td> ${o.fullName} </td>
                                                    <td><p class="badge badge-success">Received</p></td>
                                                    <td>${o.order_date}</td>
                                                    
                                                    <td>$ ${o.total}</td>
                                                    
                                                    <td><a href="OrderDetailController?o_id=${o.order_id}" class="btn btn-primary btn-sm">Feedback</a>
                                                    
                                                    <a href="CompleteOrderController?o_id=${o.order_id}" class="btn btn-secondary btn-sm">Skip</a></td>
