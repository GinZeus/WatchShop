<%-- 
    Document   : Manage_ToPack
    Created on : 29-10-2023, 15:31:00
    Author     : DELL
--%>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="box-header"> 
                                    <div class="nav flex-column nav-pills text-center flex-md-row btn-group-lg ">
                                        ...
                                        <a href="ToPackController" class="rounded-0 flex-sm-fill text-sm-center btn btn-default active"> <i class="fa fa-inbox">                      </i>To pack</a>
                                        ...
                                        <tbody>
                                            <c:forEach items="${listO}" var="o">
                                                <tr>
                                                    <th># ${o.order_id}</th>
                                                    <td> ${o.fullName} </td>
                                                    <td><p class="badge badge-success">Being packaged</p></td>
                                                    <td>${o.order_date}</td>
                                                    ...
                                                    <td><a href="OrderDetailController?o_id=${o.order_id}" class="btn btn-default btn-sm"><i class="fa fa-eye"></i></a>
                                                        ...
                                                        <a href="ChangeOrderStatus?o_id=${o.order_id}&status=3"  class="btn btn-primary btn-sm">Delivery</a></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
