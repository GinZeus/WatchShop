<%-- 
    ...
    Created on : 29-10-2023, 13:32:02
    Author     : DELL
--%>
                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="box-header"> 
                                    <div class="nav flex-column nav-pills text-center flex-md-row btn-group-lg ">
                                        <a href="ToConfirmController" class="rounded-0 flex-sm-fill text-sm-center btn  btn-default active"> <i class="fa fa-check">                     </i>To confirm</a>
                                            ...
                                            <c:forEach items="${listO}" var="o">
                                                <tr>
                                                    ...
                                                    <td><a href="OrderDetailController?o_id=${o.order_id}" class="btn btn-default btn-sm"><i class="fa fa-eye"></i></a>
                                                        ...
                                                        <a href="ChangeOrderStatus?o_id=${o.order_id}&status=2"  class="btn btn-danger btn-sm">Confirm</a></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
                                                    ...
                                                    <div class="container-fluid">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <textarea id="note" name="note"  class="form-control" placeholder="Enter a message" readonly></textarea>
