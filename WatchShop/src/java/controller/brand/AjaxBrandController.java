 ...
 * @author DELL
 */
public class AjaxBrandController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AjaxBrandController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AjaxBrandController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Product> list = pd.getProductByBrand(brand_id, index, var, sort, min, max);
        ArrayList<Product> listC = pd.getAllProductByBrand(brand_id, var, sort, min, max);
        ...
        out.println("<div class=\"box info-bar\">\n"
                ...
                + "                                                <select id=\"sort_by\" onchange=\"brandController(" + brand_id + ", 1)\" class=\"form-control\" >\n"
                ...
                + "                                                <select id=\"range\" onchange=\"brandController(" + brand_id + ", 1)\" class=\"form-control\">\n"
        ...
        for (int i = 1; i <= endP; i++) {
            out.println("<li class=\"page-item " + (i == index ? "active" : "") + "\"><a href=\"#\" onclick=\"brandController(" + brand_id + "," + i + ")\" class=\"page-link\">" + i + "</a></li>");
        }
        out.println("</ul>\n"
                + "\n"
                + "\n"
