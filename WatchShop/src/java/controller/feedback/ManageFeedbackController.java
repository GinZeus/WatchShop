    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (account == null) {
            ...
            if (account.getRole_id() == 2 || account.getRole_id() == 3) {
                ...
                ArrayList<Feedback> listFeedbackPro = fbDAO.getFeedbackFromPid(pid);
                request.setAttribute("listFeedbackPro", listFeedbackPro);
                request.setAttribute("userDAO", userDAO);
                request.setAttribute("proDAO", proDAO);
                request.getRequestDispatcher("ManageFeedbackPro.jsp").forward(request, response);
