 ...
 * @author DELL
 */
public class AjaxShopController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AjaxShopController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AjaxShopController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Product> list = pd.getProductForShop(index, var, sort, min, max);
        ArrayList<Product> listC = pd.getAllProductForShop(var, sort, min, max);
        ...
        out.println("<div class=\"box info-bar\">\n"
                ...
                + "                                                <select id=\"range\" onchange=\"shopControl(1)\" class=\"form-control\">\n"
        ...
        for (int i = 1; i <= endP; i++) {
            out.println("<li class=\"page-item " + (i == index ? "active" : "") + "\">"
                    + "<a href=\"#\" onclick=\"shopControl(" + i + ")\" class=\"page-link\">" + i + "</a></li>");
        }
        out.println("</ul>\n"
                + "\n"
                + "\n"
