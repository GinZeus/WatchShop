                            ...
                            <div class="col-xs-12">
                                ...
                                <div class="box-header"> 
                                    <div class="nav flex-column nav-pills text-center flex-md-row btn-group-lg ">
                                        ...
                                        <a href="OrderHistoryController" class="rounded-0 flex-sm-fill text-sm-center btn btn-default active "> <i class="fa fa-inbox">                  </i>History</a>
                                        ...
                                        <tbody>
                                            <c:forEach items="${listO}" var="o">
                                                <tr>
                                                    <th># ${o.order_id}</th>
                                                    <td> ${o.fullName} </td>
                                                    <td><p class="badge badge-secondary">Completed</p></td>
                                                    <td>${o.order_date}</td>
