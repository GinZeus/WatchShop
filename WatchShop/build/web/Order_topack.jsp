<%-- 
    Document   : Order_topack
    Created on : 25-10-2023, 22:00:16
    Author     : DELL
--%>
                        ...
                        <div id="customer-orders" class="col-lg-9"> 
                            <div class="box">
                                ...
                                <div class="nav flex-column flex-md-row nav-pills text-center ">
                                    ...
                                    <a href="ToPackController" class="nav-link flex-sm-fill text-sm-center font-weight-bold border-bottom border-primary   "> <i class="fa fa-inbox">                      </i>To pack</a>
                                        ...
                                        <tbody>
                                            <c:forEach items="${listO}" var="o">
                                                <tr>
                                                    <th># ${o.order_id}</th>
                                                    <td> ${o.fullName} </td>
                                                    <td><p class="badge badge-primary">Being packaged</p></td>
                                                    <td>${o.order_date}</td>
